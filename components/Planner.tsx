...
import { Plus, Trash2, CheckCircle2, Calendar as CalendarIcon, ChevronLeft, ChevronRight, Target, Trophy, Loader2 } from 'lucide-react';
    ...
    if (!targets) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-slate-500 animate-pulse">Loading Planner...</p>
            </div>
        );
    }
