...
import { Users, LogIn, User as UserIcon, Plus, ArrowLeft, Loader2, Coffee, Brain, Trophy, Crown } from 'lucide-react';
...
const Leaderboard = ({ participants, currentUser }: { participants: StudyParticipant[], currentUser: User | null }) => {
    ...
    return (
        <Card className="h-full">
            <h3 className="text-sm font-bold text-theme-text-secondary uppercase tracking-widest flex items-center gap-2 mb-4">
