...
import {
    ...
    X, CheckCircle2, AlertCircle, Clock, PieChart, Activity, Calendar, Dna, BookOpen, Globe, Landmark, Feather, Info, Loader2
} from 'lucide-react';
    ...
    if (!sessions || !syllabus) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-xs font-bold uppercase tracking-widest text-slate-500 animate-pulse">Loading Analytics...</p>
            </div>
        );
    }
    return (
