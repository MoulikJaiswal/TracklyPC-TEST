// FIX: Use default React import and extend React.Component to ensure correct type inference for class components.
...
// FIX: Extend from React.Component to inherit component properties like 'props' and 'state'.
